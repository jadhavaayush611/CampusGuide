...
import com.campusguide.academic.progress.dto.*;
...
public class StudentProgressService {
    ...
    private void recalculateGraduationEligibility(StudentProgress progress) {
        if (progress.getRoadmapId() != null) {
            try {
                com.campusguide.academic.roadmap.dto.RoadmapResponse roadmap = roadmapService.getRoadmapById(progress.getRoadmapId());
