...
/**
 * Extension point contract for PostgreSQL + pgvector vector store backend integration.
 */
public class PgVectorStore implements VectorStore {
    ...
    public PgVectorStore() {
        this.index = VectorIndex.builder()
                .indexName("pgvector_knowledge_index")
                .dimension(1536)
    ...
    public void index(VectorRecord record) {
        throw new UnsupportedOperationException("pgvector integration requires active PostgreSQL connection and pgvector extension.");
    }
