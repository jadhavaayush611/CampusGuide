...
/**
 * Extension point contract for Milvus open-source vector database integration.
 */
public class MilvusVectorStore implements VectorStore {

    private final VectorIndex index = VectorIndex.builder()
            .indexName("milvus_knowledge_index")
            .dimension(1536)
    ...
    public void index(VectorRecord record) {
        throw new UnsupportedOperationException("Milvus integration requires Milvus Java SDK.");
    }
