...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(com.campusguide.modules.notification.exception.NotificationNotFoundException.class)
    public ResponseEntity<Map<String, String>> handleNotificationNotFoundException(com.campusguide.modules.notification.exception.NotificationNotFoundException ex) {
        Map<String, String> error = new HashMap<>();
        error.put("error", ex.getMessage());
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body(error);
    }
