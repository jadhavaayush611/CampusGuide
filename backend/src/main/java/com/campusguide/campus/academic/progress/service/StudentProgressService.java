...
import com.campusguide.campus.academic.progress.dto.*;
...
public class StudentProgressService {
    ...
    private void recalculateGraduationEligibility(StudentProgress progress) {
        if (progress.getRoadmapId() != null) {
            try {
                com.campusguide.campus.academic.roadmap.dto.RoadmapResponse roadmap = roadmapService.getRoadmapById(progress.getRoadmapId());
