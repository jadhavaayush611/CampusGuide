  ...
  return (
    <DialogPrimitive.Root open={isOpen} onOpenChange={(open) => { if (!open) onClose(); }}>
      <DialogPrimitive.Portal>
        <DialogPrimitive.Overlay className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-xs animate-in fade-in duration-200" />
          ...
          <div className="relative w-full max-w-xl bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden z-10 space-y-6 p-6 sm:p-8">
            ...
            <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {event.hasConflict && (
                    <span className="inline-flex items-center gap-1 px-2.5 py-1 bg-red-100 text-red-700 text-xs font-bold rounded-lg border border-red-200">
                      <AlertCircle className="w-3.5 h-3.5 text-red-600" aria-hidden="true" /> Overlap Conflict
                    </span>
                  )}
                </div>

                <DialogPrimitive.Title className="text-2xl font-bold text-gray-900 tracking-tight">
                  {event.title}
              ...
              <DialogPrimitive.Close asChild>
                <button
                  className="p-2 hover:bg-gray-100 text-gray-400 hover:text-gray-700 rounded-full transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-1"
            ...
            <div className="space-y-4 text-sm text-gray-700">
              ...
              {event.location && (
                <div className="flex items-start gap-3">
                  <MapPin className="w-4 h-4 text-purple-600 shrink-0 mt-0.5" aria-hidden="true" />
                  <div>
              ...
              {event.participants && event.participants.length > 0 && (
                <div className="flex items-start gap-3">
                  <Users className="w-4 h-4 text-indigo-600 shrink-0 mt-0.5" aria-hidden="true" />
                  <div>
              ...
              {event.attachments && event.attachments.length > 0 && (
                <div className="flex items-start gap-3">
                  <Paperclip className="w-4 h-4 text-amber-600 shrink-0 mt-0.5" aria-hidden="true" />
                  <div>
                    ...
                    <div className="space-y-1.5 mt-1">
                      {event.attachments.map((att, idx) => (
                        <a
                          ...
                          className="inline-flex items-center gap-2 text-xs font-semibold text-blue-600 hover:underline bg-blue-50 px-3 py-1.5 rounded-xl focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-1"
                        >
                          <span>{att.name}</span>
            ...
            <div className="pt-4 border-t border-gray-100 flex items-center justify-between gap-3">
              {event.linkUrl ? (
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2.5 bg-blue-50 hover:bg-blue-100 text-blue-700 rounded-xl font-bold text-xs transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-1"
                >
              ...
              <div className="flex items-center gap-2">
                {isPersonal && (
                  <>
                    <button
                      ...
                      className="p-2.5 bg-red-50 hover:bg-red-100 text-red-600 rounded-xl transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-1"
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold text-xs transition-colors shadow-sm focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-blue-600 focus-visible:ring-offset-1"
                    >
                ...
                {!isPersonal && (
                  <DialogPrimitive.Close asChild>
                    <button
                      className="px-5 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-800 rounded-xl font-bold text-xs transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-gray-600 focus-visible:ring-offset-1"
                    >
                      Close
                    </button>
                  </DialogPrimitive.Close>
