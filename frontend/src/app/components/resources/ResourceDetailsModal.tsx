      ...
      <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden">
        ...
        <div className="p-6 border-b border-gray-200 flex items-start justify-between gap-4 bg-gray-50/50">
          <div>
            ...
            <h2 className="text-2xl font-bold text-gray-900 leading-snug">{resource.title}</h2>
          </div>
        ...
        <div className="p-4 border-t border-gray-200 bg-gray-50 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={onClose}
              className="px-4 py-2.5 bg-white text-gray-700 border border-gray-300 font-medium text-sm rounded-xl hover:bg-gray-100 transition-colors"
            >
              Close
            </button>
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-6 py-2.5 bg-blue-600 text-white font-semibold text-sm rounded-xl hover:bg-blue-700 transition-colors shadow-md"
            >
