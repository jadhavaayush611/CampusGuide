...
const FALLBACK_COURSES: CourseDto[] = [
  {
    ...
    term: 'Fall 2026',
    grade: 'A',
    syllabusUrl: '/api/v1/resources/download/cs-301-syllabus.pdf',
  },
  {
    id: 'c2',
    code: 'CS-304',
    ...
    term: 'Fall 2026',
    grade: 'A-',
    syllabusUrl: '/api/v1/resources/download/cs-304-syllabus.pdf',
  },
  {
    id: 'c3',
    code: 'CS-310',
    ...
    term: 'Fall 2026',
    grade: 'B+',
    syllabusUrl: '/api/v1/resources/download/cs-310-syllabus.pdf',
  },
  {
    id: 'c4',
    code: 'MATH-201',
    ...
    term: 'Fall 2026',
    grade: 'A',
    syllabusUrl: '/api/v1/resources/download/math-201-syllabus.pdf',
  },
  {
    id: 'c5',
    code: 'EE-210',
    ...
    status: 'IN_PROGRESS',
    term: 'Fall 2026',
    syllabusUrl: '/api/v1/resources/download/ee-210-syllabus.pdf',
  },
  {
    id: 'c6',
    code: 'CS-401',
    ...
    status: 'PLANNED',
    term: 'Spring 2027',
    syllabusUrl: '/api/v1/resources/download/cs-401-syllabus.pdf',
  },
  {
    id: 'c7',
    code: 'CS-405',
    ...
    status: 'PLANNED',
    term: 'Spring 2027',
    syllabusUrl: '/api/v1/resources/download/cs-405-syllabus.pdf',
  },
  {
    id: 'c8',
    code: 'PHY-102',
    ...
    term: 'Spring 2026',
    grade: 'A',
    syllabusUrl: '/api/v1/resources/download/phy-102-syllabus.pdf',
  },
];

const FALLBACK_TIMETABLE: TimetableSlotDto[] = [
  // MONDAY (Ends at 2:30 PM)
  {
    id: 't1',
    courseId: 'c1',
    courseCode: 'CS-301',
